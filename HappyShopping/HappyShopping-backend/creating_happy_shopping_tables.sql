...
DROP SCHEMA IF EXISTS `happy-shopping-db`;

CREATE SCHEMA `happy-shopping-db`;
USE `happy-shopping-db` ;

CREATE TABLE IF NOT EXISTS `happy-shopping-db`.`product_category` (
...
CREATE TABLE IF NOT EXISTS `happy-shopping-db`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
